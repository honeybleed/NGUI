...
@Component({
  selector: 'app-stop-vm-message-box',
  templateUrl: './stop-vm-message-box.component.html',
  styleUrls: ['./stop-vm-message-box.component.scss']
})
export class StopVmMessageBoxComponent implements OnInit {
  vmName: string;
  buttonText = '';
  intervalID;
  countSecond = 3;
